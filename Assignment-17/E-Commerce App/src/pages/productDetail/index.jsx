...
const ProductDetail = () => {
    ...
    const getData = async()=>{ 
        try {
            const fetc = await axios.get(`https://fakestoreapi.com/products/${params.id}`)
            setData(fetc.data)
    ...
    <div className="flex flex-col md:flex-row -mx-4">
      ...
      <div className="md:flex-1 px-4">
        ...
        <div className="flex py-4 space-x-4">
          ...
          <Link to={'/'}>
          <button type="button" className="h-14 px-6 py-2 font-semibold rounded-xl bg-black text-white">
            Go Back
          </button>
          </Link>
        </div>
